...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText("TensorFlow Lite Demo");
            ...
            public void onClick(View arg0) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        dest_bitmap =img.ImageProcessing(src_bitmap,MainActivity.this);//通过OpenCV的getNativeObjAddr()把地址传递给底层JNI
                        long T3 = System.currentTimeMillis();
                        Log.e(TAG, "Run time,ImageProcessing="+(T3-T2)+"ms");
